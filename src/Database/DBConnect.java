...
//			if(pst != null) pst.close();
	...
	public static void optionPrice() {
		String sql = "SELECT optionId, optionName, optionPrice FROM optionData";
	...
	public static boolean insertSelectData(int orderID, int categoryID, int productID, int option1ID, int option2ID, int option3ID, int number) {
		String sql = "INSERT INTO selectData VALUES ('" + orderID + "' , '" + categoryID + "' , '" + productID + "' , '"
				+ option1ID + "' , '" + option2ID + "' , '" + option3ID + "' , '" + number + "')";
		try {
